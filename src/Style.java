...
public class Style extends JFrame
{
    ...
    {
        // Renew all color settings each time Style object is made
        db.selectSettings();
    }
    ...
    // systemColor takes RGB values from database
        int colorR = db.settingsColorR.get(0);
        int colorG = db.settingsColorG.get(0);
        int colorB = db.settingsColorB.get(0);
    Color systemColor = new Color(colorR, colorG, colorB);
